    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 pt-20 pb-12">
        ...
        <p className="mt-8 max-w-xl text-[15px] leading-relaxed text-muted-foreground">
          ...
          Place your maximum — our system bids on your behalf up to that ceiling.
        </p>
        {query && (
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-14">
        {visible.length === 0 ? (
          <div className="py-24 text-center text-muted-foreground">
            ...
            <Link to="/auctions" search={{}} className="mt-6 inline-block text-[11px] uppercase tracking-[0.18em] underline underline-offset-4">
              View all works
            </Link>
          </div>
        ) : (
